...
def drawCanvas(root):
    canvas=tk.Canvas(root, width=450, height=500, background='white')
...
def InfoGUIy(rt):
    ...
    heading = Label(
        frame,
        text="3x3 Cube Solver Instructions",
        font=("Arial", 32, "bold"),
        fg="#C20000",
        bg="#FFFFFF",
        pady=18
    ...
    instructions = (
        ...
        "Features:\n"
        "• Enter your own moves, then click 'execute' to apply them.\n"
        "• Click 'Scramble' to generate a random scramble, or create your own and apply 'Custom Scramble'.\n"
        "• Use the solve buttons to instantly solve, or step through the solution process.\n"
    )
    InfoLabel = Label(
        frame,
        text=instructions,
    ...
    # Start button, bold and colored
    InfoQuitButton = Button(
        frame,
        text="Start Cubing",
        fg="#FFFFFF",
        bg="#C20000",
        ...
        command=lambda: rt.destroy(),
        width=20,
        height=2
    )
    InfoQuitButton.grid(row=2, column=0, pady=(10, 12), sticky="n")
...
def GUIy():
    ...
    frame = Frame(root)
    frame.grid(row=0, column=1, sticky="nsew", padx=20, pady=15)
    row_ = 0
    Label(frame, text="3x3 Cube Solver", fg="red", font=("Arial", 28, "bold")).grid(row=row_, column=0, columnspan=3, pady=(0, 10), sticky="w")
    row_ += 1
    Button(frame, text="New",font=("Arial", 11, "bold"),bg="green",fg="white" ,command=GUInewCube, width=7).grid(row=row_, column=3, sticky="e")  
    Label(frame, text="Enter move(s):",font=("Arial", 12, "bold")).grid(row=row_, column=0, sticky="w")
    move_entry = Entry(frame, textvariable=move, width=14)
    move_entry.grid(row=row_, column=1, sticky="w", padx=4)
    Button(frame, text="Execute",font=("Arial", 12, "bold"),bg="green",fg="white", command=lambda: GUImakeMove(move),width=7).grid(row=row_, column=2, sticky="w", padx=(6, 0))
    row_ += 1
    ScrambleLabel = Label(frame, text="Scramble will be displayed here", font=("Arial", 13, "bold"),wraplength=190, justify="center", height=4)
    ScrambleLabel.grid(row=row_, column=0, columnspan=3, pady=(8, 0))
    row_ += 1
    Button(frame, text="Scramble", bg="#C20000", fg="#FFFFFF", font=("Arial", 13, "bold"), activebackground="#A60000", activeforeground="#FFFFFF", bd=0, relief="ridge", command=GUIScramble, width=12).grid(row=row_, column=0, sticky="w")
    Button(frame, text="Copy Scramble",bg="#C20000", fg="#FFFFFF", font=("Arial", 13, "bold"), activebackground="#A60000", activeforeground="#FFFFFF", bd=0, relief="ridge" , command=lambda: GUItoClipboard(get_scramble()), width=14).grid(row=row_, column=2, sticky="w")
    row_ += 1
    Button(frame, text="Solve Cube",bg="#C20000", fg="#FFFFFF", font=("Arial", 13, "bold"), activebackground="#A60000", activeforeground="#FFFFFF", bd=0, relief="ridge", command=GUISolve, width=12).grid(row=row_, column=0, pady=(8,0), sticky="w")
    Button(frame, text="Copy Solution",bg="#C20000", fg="#FFFFFF", font=("Arial", 13, "bold"), activebackground="#A60000", activeforeground="#FFFFFF", bd=0, relief="ridge", command=lambda: GUItoClipboard(get_moves()), width=14).grid(row=row_, column=2, sticky="w")
    row_ += 1
    Button(frame, text="Cross", bg="lightblue",font=("Arial", 13, "bold") ,command=lambda: GUIsetSolve("cross")).grid(row=row_, column=0, pady=3, sticky="w")
    Button(frame, text="F2L", bg="lightblue", font=("Arial", 13, "bold"),command=lambda: GUIsetSolve("F2L")).grid(row=row_, column=1, pady=3, sticky="w")
    Button(frame, text="OLL", bg="lightblue", font=("Arial", 13, "bold"),command=lambda: GUIsetSolve("OLL")).grid(row=row_, column=2, pady=3, sticky="w")
    Button(frame, text="PLL", bg="lightblue", font=("Arial", 13, "bold"),command=lambda: GUIsetSolve("PLL")).grid(row=row_, column=3, pady=3, sticky="w")
    row_ += 1
    SolutionLabel = Label(frame, text="Solution will be displayed here", wraplength=300, justify="center", height=7, anchor="w")
    SolutionLabel.grid(row=row_, column=0, columnspan=3, pady=(10, 0), sticky="w")
    row_ += 1
    Label(frame, text="Total moves:", font=("Arial", 13, "bold")).grid(row=row_, column=0, sticky="e")
    SolutionNumberLabel = Label(frame, text="0",font=("Arial", 13, "bold"))
    SolutionNumberLabel.grid(row=row_, column=1, sticky="w")
    row_ += 1
    Label(frame, text="Cross:", font=("Arial", 13, "bold")).grid(row=row_, column=0, sticky="e")
    CrossNumberLabel = Label(frame, text="0",font=("Arial", 13, "bold"))
    CrossNumberLabel.grid(row=row_, column=1, sticky="w")
    Label(frame, text="F2L:", font=("Arial", 13, "bold")).grid(row=row_, column=2, sticky="e")
    F2LNumberLabel = Label(frame, text="0",font=("Arial", 13, "bold"))
    F2LNumberLabel.grid(row=row_, column=3, sticky="w")
    row_ += 1
    Label(frame, text="OLL:", font=("Arial", 13, "bold")).grid(row=row_, column=0, sticky="e")
    OLLNumberLabel = Label(frame, text="0",font=("Arial", 13, "bold"))
    OLLNumberLabel.grid(row=row_, column=1, sticky="w")
    Label(frame, text="PLL:", font=("Arial", 13, "bold")).grid(row=row_, column=2, sticky="e")
    PLLNumberLabel = Label(frame, text="0",font=("Arial", 13, "bold"))
    PLLNumberLabel.grid(row=row_, column=3, sticky="w")

    # --- Rotation Frame (left, below Canvas) ---
    Rframe = Frame(root)
    Rframe.grid(row=1, column=0, sticky="n", pady=(10, 0))
    Label(Rframe, text="Rotate cube:").grid(row=0, column=0, columnspan=2, pady=(0, 5))
    Button(Rframe, text="← Y", command=lambda: GUIyRotation("Y")).grid(row=1, column=0, padx=4)
    Button(Rframe, text="Y' →", command=lambda: GUIyRotation("Yi")).grid(row=1, column=1, padx=4)
